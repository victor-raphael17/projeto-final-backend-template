...
- [ ] FollowService
- [ ] Impedir de seguir a si mesmo (validação no FollowService via SelfFollowException)
...
- [ ] PostService
- [ ] Policy: só o dono edita/deleta (PostPolicy)
...
- [ ] LikeService
- [ ] Operações idempotentes: curtir repetido mantém curtido, descurtir repetido mantém descurtido
...
- [ ] CommentService
- [ ] Policy: só o dono edita/deleta (CommentPolicy)
...
### 10 - Dockerização
- [ ] Dockerfile multi-stage (Composer + FrankenPHP/PHP 8.4 alpine)
